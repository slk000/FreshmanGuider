...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_button1 setTitle:@"新闻" forState:UIControlStateNormal];
        ...
        [_button2 setTitle:@"Tab2" forState:UIControlStateNormal];
        ...
        [_button3 setTitle:@"周边" forState:UIControlStateNormal];
        ...
        [_button4 setTitle:@"个人" forState:UIControlStateNormal];
