...
- (void)setupSlideBar {
    ...
    sliderBar.itemsTitle = @[@"要l闻", @"视频", @"上海", @"娱乐", @"体育NBA", @"财经", @"科技", @"社会", @"军事", @"时尚", @"汽车", @"游戏", @"图片", @"股票"];
...
- (void)setupTableView {
    ...
    UINib *nib2 = [UINib nibWithNibName:@"TableViewCell2" bundle:nil];
    [self.tableView registerNib:nib2 forCellReuseIdentifier:@"ContentCell2"];
    
//    [self.tableView registerClass:[TestVC class] forCellReuseIdentifier:@"ContentCell2"];
//    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"slk" bundle:nil];
    
    UINib *nib1 = [UINib nibWithNibName:@"TableViewCell" bundle:nil];
    [self.tableView registerNib:nib1 forCellReuseIdentifier:@"ContentCell1"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *cellid = indexPath.row%2?@"ContentCell1":@"ContentCell2";

    TableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:cellid];
    
//    UIView *tmp = [[[NSBundle mainBundle] loadNibNamed:@"ContentCell2" owner:nil options:nil]firstObject];
//    tmp.frame = CGRectMake(0, 0, CGRectGetMaxY(self.view.frame) - CGRectGetMaxY(self.slideBar.frame), CGRectGetWidth(self.view.frame));
    
        cell.frame = CGRectMake(0, 0, 600.0, 375.0);
